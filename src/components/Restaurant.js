...
const Restaurant = () => {
    ...
    let getRestaurantDetails = async() =>{
        ...
        // console.log(rDetails.cuisine.map((value) => {
        //     return value.name;
        // }).join(", "));
    };
    ...
    let addQty = (index)=>{
        ...
        setTotalPrice(menu[index].price + totalPrices)
        menu[index].qty += 1;
        setMenu([...menu]);
    };
    let removeQty = (index)=>{

        setTotalPrice(totalPrices - menu[index].price)
        menu[index].qty -= 1;
        setMenu([...menu]);
    };
